...
//		return (name.hashCode() % 3; -> 이름만 비교
	...
	public boolean equals(Object obj) {
		...
		//if(comparePerson.age==this.age && comparePerson.name.equals(this.name)) { 둘 다
		//if(comparePerson.name.equals(this.name)) { 이름만
		if(comparePerson.age==this.age) { //나이만
