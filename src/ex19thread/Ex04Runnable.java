...
/*
 ...
 다른 클래스를 상속받아야 한다면 Runnable 인터페이스를 구현해서 쓰레드 클래스를 정의해야한다.
 */
...
public class Ex04Runnable {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 해당 방법도 결국은 Thread클래스를 통해 쓰레드를 생성하게 된다.		 
		 */
