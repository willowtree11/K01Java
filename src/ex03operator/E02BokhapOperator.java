...
public class E02BokhapOperator {
	...
	public static void main(String[] args) {
		...
		e +=2.1; //3.1+2.1=5.2
		e *=2; //5.2*2=10.4
		e += e; //e = e+e; 10.4+10.4=20.8
		System.out.println("e의 결과값: " +e);
		
		int n=5;
		
		//n = n*2.7; [에러발생] 연산의 결과가 double이므로 대입 불가
		n=(int)(n*2.7); //명시적 형변환 후 int형 변수에 대입함
		System.out.println("n의 결과값: "+n); //13
		
		n*=2.7; /*
					정상실행 됨, 복합대입연산자는 문법의 구조상 기존 자료형을 그대로 유지하는 특성을 가짐
					따라서 결과는 정수인 35이 되고, 소수 이하는 버려짐
				*/
