...
/* 
do~while 문
: 반드시 한번은 실행해야 할 경우 사용하는 반복문으로 조건검사 없이 무족너 한번은 실행된다.
형식>
반복을 위한 초기값;
do{
	실행문장;
	반복문을 탈출하기 위한 증감식;
	}while(조건식); <= 반드시 ;(세미콜론)으로 마무리 한다.
-문장 끝마다 ;
-로또처럼 난수를 '먼저' 만들어 두어야 중복이 되는지 아닌지 체크를 할 수 있는 비교대상이 있어야만 하는 경우
 ...
 */
	...
	/*
	 시나리오] 1부터 1000까지의 정수 중 4의 배수이거나 7의 배수인 수의 합을 구하여 출력하는
	 프로그램을 작성하시오. 단, do~while문을 사용할 것
	 */
	...
	System.out.println("1~1000 사이 4 or 7의 배수 합: " + total);
	
	/*
	 시나리오] 국어, 영어, 수학 점수를 사용자로부터 입력받은 후
	 평균을 구해 A~F학점을 판단하여 출력하는 프로그램을 작성하시오.
	 단, 사용자가 x,X(대소문자 구분 없음)를 입력하면 프로그램이 종료되어야 하며
	 do~while문으로 구현해야 한다
	 */
	...
	int exitCode;
		do {
			...
			/*
			 ...
			 점수의 구간을 구하기 위해 총잠을 30으로 나눠준다
			 ex) int 90~99점 = case 9 
			  */
		...
		/*
		 ...
		 x외의 다른 문자 가령 a 등을 입력한 경우
		 : 위 경우에 해당되지 않으므로 Loop 반복
