		...
		try {	
			...
			if(con!=null) {
				...
				3]쿼리문작성
					...
					스페이스를 삽입하는것이 좋다. 그렇지 않으면 문장이
					이어지게되어 SyntaxError가 발생하게된다. 
				 */
				...
				/*
				5] Statement객체를 사용하여 Oracle로 작성된 쿼리문을 전송하고
				실행한다. 실행후 결과를 반환하면 ResultSet객체를 통해 받는다.
				 */
				...
				while(rs.next()) {
					...
					콘솔에 내용을 출력한다. 
					getXXX()계열의 함수는 문자, 숫자, 날짜를 사용하기위해
