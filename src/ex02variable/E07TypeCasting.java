...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		byte b1=65;
		short s1;
		s1=b1; //byte형이 short형 보다는 작은 자료형
		System.out.printf("b1은 %d, s1은 %d%n", b1, s1);
		
		/*
		 아래 코드는 자동형변환은 아니나 CPU는 int보다 작은 자료형을 int로 간주하고 연산을 진행하며,
		 결과도 int로  반환한다. CPU만의 특성
		 */
		int num1=b1+s1;
		int num2=num1;
		...
		/*
		 명시적 형변환: 큰 상자의 자료를 작은상자의 자료형에 할당해야 할 때 사용함.
		...
		/*
		 소수점 아래 부분이 버려지므로 데이터 손실 있음. 따라서 특수한 경우가 아니라면 사용을 자제해야 함
		 */
		int num3;
		double dl=3.14;
		num3=(int)dl;
		...
		/*
		 char와 int를 연산하면 결과는 int이므로 char형 변수에 대입하려면 명시적(강제) 형변환 후 대입해야 한다
		 */
		
		char ch3='A', ch4;
		int num4=2;
		
		//ch4=ch3+num4; 타입이 맞지 않아 에러 발생
		ch4=(char)(ch3+num4);
