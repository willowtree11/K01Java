...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 -방법 1: float를 long으로 형변환 후 연산
		 -방법 2: 계산결과 전체를 long형으로 명시적(강제) 형변환
		 */
		...
		/*
		 ...
		 - 소수점이 있는 데이터를 float에 대입하려면 접미사 f 또는 F를 사용한다
		 - 형변환도 가능하지만 Java에서는 권장하지 않는다
		  */
		
		float f3 = 100;
		
		//float f4 = 3.14; => [에러발생] 3.14를 double형으로 인식함
		float f4 = (float)3.14; //형변환 후 대입(비권장)
		System.out.println("f4 = "+ f4);
		
		float f5 = 3.14F; //접미사f를 통해 float임을 표현(권장)
