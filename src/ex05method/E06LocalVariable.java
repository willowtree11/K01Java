...
/*
 ...
 -기본 자료형(문자, 정수, 실수, 논리)은 스택(Stack)이라는 메모리 공간을 사용한다.
 ...
 */
	public static void main(String[] args) {
		...
		/*
		 ...
		 main지역에서 num을 선언하면 그보다 작은 if문의 지역에서는 같은 이름의 변수를 선언할 수 없다.
		 상위(큰) 지역에서 이미 선언하여 메모리상에 상주하고 있기 때문.
	...
	// main에서 선언한 변수 num이 메모리에 아직 남아 있지만, simpleFunc() 메소드는 서로 다른 지역에 정의되었으므로
	// 같은 이름의 변수를 선언할 수 있다.
