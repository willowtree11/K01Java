...
//		return total;
//	}
//	static int getTotal(int parma1, int param2, int param3) {
//		int total=0;
//		total += (param1+param2+param3);
//		return total;
//	}
	
	// 가변인자를 통한 메소드 정의시 매개변수가 하나의 타입일대만 가능하다.
	...
	public static void main(String[] args) {
		...
		System.out.println("getTotal(args1, args2, arg3)호출: "+getTotal(10, 20, 30));
		System.out.println("getTotal(매개변수 6개)호출: "+getTotal(10, 20, 30, 40, 50, 60));
		
		//매개변수의 타입 double이 포함되어 호출 불가능(int로 선언했었기 때문에)
		//System.out.println("getTotal(arg1, arg2)호출: "+getTotal(10, 20.1));
	}
