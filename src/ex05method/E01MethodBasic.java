...
public class E01MethodBasic {
	...
	/*
	 메소드 정의1 :	반환타입 o(int), 매개변수o(int a, int b) 형태로 정의 
	...
	/*
	 메소드 정의2 :	반환타입 x, 매개변수x 형태로 정의 
	 			-> 전달되는 값 없이 이름을 입력받은 후 namePrint()함수를
	...
	/*
	 메소드 정의 3 : 반환값 x, 매개변수 o 의 형태로 정의
	...
	public static void main(String[] args) {
		...
		menuPrint(); //아무것도 없이 호출하면 반환이 안되는 경우
	} //메인에서 시작해서 메인에서 끝남
